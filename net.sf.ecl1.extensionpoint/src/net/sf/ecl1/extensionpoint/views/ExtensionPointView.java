...
public class ExtensionPointView extends ViewPart implements ExtensionPointManagerChangeListener {
	 ...
	 */
	public static final String ID = "net.sf.ecl1.extensionpoint.views.ExtensionPointView";
	...
	public void createPartControl(Composite parent) {
		...
		viewer.setContentProvider(new ExtensionPointsViewContentProvider());
		viewer.setLabelProvider(new ExtensionPointViewLabelProvider());
	...
	private void hookContextMenu() {
		...
		menuMgr.addMenuListener(new IMenuListener() {
			public void menuAboutToShow(IMenuManager manager) {
				ExtensionPointView.this.fillContextMenu(manager);
			}
		});
